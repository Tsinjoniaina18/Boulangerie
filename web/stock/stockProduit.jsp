...
<div id="searchPopup" class="popup">
    ...
    <form action="/Boulangerie/rechercheProduits" method="post">
        <div class="form-grid">
            <div class="form-grp">
            ...
            <div class="form-grp">
                ...
                <input type="number" id="prixMin" name="prixMin" step="0.01" class="form-input">
            </div>
            <div class="form-grp">
                <label for="prixMax" class="form-label">Prix Max :</label>
                <input type="number" id="prixMax" name="prixMax" step="0.01" class="form-input">
            </div>
            <div class="form-grp">
