...
%>
    ...
    <div id="searchPopup" class="popup">
        ...
        <form action="/Boulangerie/listeVenteServlet" method="post">
            <div class="form-grid">
                <div class="form-grp">
                ...
                <div class="form-grp">
                    <label for="vente" class="form-label">Type :</label>
                    <select name="vente" id="vente" class="form-input">
            ...
            <div class="form-actions">
                <button type="submit" class="form-button btn-primary">Lister</button>
